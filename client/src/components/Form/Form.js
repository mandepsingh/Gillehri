...
const Form = () => {
    ...
    return(
        <Paper className= {classes.paper}>
            ...
            <TextField name="message" varirant="outlined" label="Message" fullWidth value={postData.message} onChange={(e)=> setPostData({ ...postData, message: e.target.value })} />
